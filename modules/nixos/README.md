...
Niri is the sole managed login session. Its bindings live in
`modules/linux/config/niri/config.kdl`; Noctalia is the sole lock,
notification, and wallpaper authority.

...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mei/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mei/bin" "/profile/bin" "/Users/mei/.npm-packages/bin" "/Users/mei/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC

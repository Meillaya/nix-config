...
in
{
  bun = super.bun.overrideAttrs (finalAttrs: previousAttrs: {
    inherit version;

    src = sources.${super.stdenvNoCC.hostPlatform.system} or (throw "Unsupported system: ${super.stdenvNoCC.hostPlatform.system}");
